...
规定 **game-service** 中 **Player 掠夺结算**与 **City 地图缓存**的 **Mongo 持久化**、**写序**与**重启恢复**语义；与 [`docs/pekko-game-actor-openspec-roadmap.md`](../../../../../docs/pekko-game-actor-openspec-roadmap.md) 阶段 6 一致，并建立在 [`game-plunder-settlement-ask-protocol`](../../../../specs/game-plunder-settlement-ask-protocol/spec.md) 的 Ask 协议之上。
